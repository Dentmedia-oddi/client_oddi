      ...
      <div name="construction" className="w-full bg-white py-20 px-4">
        <div className="max-w-[1240px] mx-auto grid md:grid-cols-1">
          <img
            ...
            src={under}
            alt="Imagen de sitio en construccion"
            title="construccion"
          />
          <div className="flex flex-col justify-center">
            ...
            <p className="text-center md:text-xl sm:text-xl text-xl font-Regular">
              Pronto podrás disfrutar de las plantillas para especialidades
              odontológicas. <br /> Escribenos a{" "}
              <a
                href="mailto:info@oddi.es"
                className="text-[#0076A5] font-bold"
              >
                info@oddi.es
              </a>{" "}
