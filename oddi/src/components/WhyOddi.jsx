      ...
      <div className="max-w-[1240px] mx-auto grid md:grid-cols-2">
        <div className="flex flex-col justify-center text-justify">
          ...
          <p>
            ...
            tratamiento. <br /> Me inspira la idea de un futuro donde las anotaciones
            sean generadas de manera sencilla y efectiva haciendo que los datos
            clínicos se transformen en cuestión de segundos. <br /> Visualizo una
            práctica dental unificada con los registros de salud del paciente
            donde los diagnósticos se reflejan de forma concluyente, brindando a
            nuestros pacientes la tranquilidad de recibir un tratamiento
            adecuado y transparente. <br /> ¡Es hora de marcar la diferencia y
            construir un futuro dental más eficiente, preciso y extraordinario!
