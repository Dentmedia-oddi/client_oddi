        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-1 flex justify-center items-center">
            <div className="h-4 w-4 sm:h-10 sm:w-10 md:h-14 md:w-14">
              <img src={icon1} alt="_" title="icono1" className="h-full w-full mx-auto" />
            </div>
          </div>
          ...
          <div className="col-span-1 flex justify-center items-center">
            <div className="h-4 w-4 sm:h-10 sm:w-10 md:h-14 md:w-14">
              <img src={icon2} alt="_" title="icono2" className="h-full w-full mx-auto" />
            </div>
          </div>
          <div className="col-span-11">
            <p className="text-justify">
          ...
          <div className="col-span-1 flex justify-center items-center">
            <div className="h-4 w-4 sm:h-10 sm:w-10 md:h-14 md:w-14">
              <img src={icon3} alt="_" title="icono3" className="h-full w-full mx-auto" />
            </div>
          </div>
          <div className="col-span-11">
            <p className="text-justify">
