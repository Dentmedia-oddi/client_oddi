  ...
  return (
    <div className="text-white">
      <div className="max-w-[800px] mt-[-80px] w-full h-screen mx-auto text-center flex flex-col justify-center">
        <h1 className="md:text-7xl sm:text-6xl text-3xl  md:py-2 font-ExtraBold ">ODDI</h1>
        <h3 className=" text-[#0076A5] md:text-4xl sm:text-2xl text-xl  md:py-2">Odonto Diagrama Digital</h3>
        ...
        <p className=" text-[#1DCAD3] md:text-3xl sm:text-xl text-xl font-ExtraBold ">{word}</p>
